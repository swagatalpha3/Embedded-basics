// ======================================================================
// 08_CAPACITOR_PWM.v generated from TopDesign.cysch
// 03/12/2020 at 18:54
...
module ADC_SAR_v3_10_0 (
	...
	cy_clock_v1_0
		#(.id("0dbfcaf3-69b8-46ca-bab8-e4d5fc94448b/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
...
// ADC_SAR_v3_10(ADC_Clock=1, ADC_Clock_Frequency=1200000, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=0, ADC_Resolution=8, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=4, Sample_Rate=100000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_10, CY_CONFIG_TITLE=ADC_out, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_out, CY_INSTANCE_SHORT_NAME=ADC_out, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=ADC_out, )
module ADC_SAR_v3_10_3 (
	...
	cy_clock_v1_0
		#(.id("1694f15a-64e4-4737-8f7b-8d2890826f9c/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("833333333.333333"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__capacitor_net;
	wire [0:0] tmpFB_0__capacitor_net;
	wire [0:0] tmpIO_0__capacitor_net;
	wire [0:0] tmpINTERRUPT_0__capacitor_net;
	electrical [0:0] tmpSIOVREF__capacitor_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		capacitor
		 (.oe(tmpOE__capacitor_net),
		  .y({Net_41}),
		  .fb({tmpFB_0__capacitor_net[0:0]}),
		  .io({tmpIO_0__capacitor_net[0:0]}),
		  .siovref(tmpSIOVREF__capacitor_net),
		  .interrupt({tmpINTERRUPT_0__capacitor_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__capacitor_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("82d0588a-0b33-47a2-803f-618cec6c89af"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
    ...
    UART_v2_50_2 UART (
        ...
        .reset(1'b0),
        .rx(Net_215),
        .tx_interrupt(Net_216),
        .rx_interrupt(Net_217),
        .tx_data(Net_218),
        .tx_clk(Net_219),
        .rx_data(Net_220),
        .rx_clk(Net_221));
	...
	wire [0:0] tmpOE__CAP_OUT_net;
	wire [0:0] tmpFB_0__CAP_OUT_net;
	wire [0:0] tmpIO_0__CAP_OUT_net;
	wire [0:0] tmpINTERRUPT_0__CAP_OUT_net;
	electrical [0:0] tmpSIOVREF__CAP_OUT_net;

	cy_psoc3_pins_v1_10
		#(.id("3976a76a-e69a-4115-87d2-acbb0aaab887"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CAP_OUT
		 (.oe(tmpOE__CAP_OUT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CAP_OUT_net[0:0]}),
		  .analog({Net_229}),
		  .io({tmpIO_0__CAP_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__CAP_OUT_net),
		  .interrupt({tmpINTERRUPT_0__CAP_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CAP_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
